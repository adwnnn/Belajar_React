      ...
      <header>
        ...
        <div className='head-text'>
          <div className='text-on-image'>
            ...
            <Media image="PohonBeringin.png"></Media>
            </div> 
        ...
        <div className='head-text'>
          <div className='text-on-image'>
            ...
            <Media image="Kepalabanteng.png"></Media>
             </div>    
        ...
        <div className='head-text'>
          ...
          <Media image="PadiKapas.png"></Media>
           </div> 
          ...
          <div class='jarak'>
            <select name="gender" id="jenis-kelamin" classNam='form-input' placeholder='Jenis Kelamin'>
